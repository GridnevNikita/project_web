...
def filter_by_currency(operations: List[Dict], currency: str) -> Iterator[Dict]:
    """
    Фильтрует список операций по указанной валюте.
    """
    return (
        operation
...
def transaction_descriptions(operations: List[Dict]) -> Iterator[str]:
    """
    Извлекает описания транзакций из списка операций.
    """
    for operation in operations:
